...
try:
    ...
    print("Warning: mediapipe not available for Python 3.13. Please downgrade to Python 3.11 or 3.12")
    print("Alternatively, install using: pip install mediapipe")
    print("\nTo use Python 3.11, you can:")
    print("1. Download Python 3.11 from python.org")
    print("2. Create a virtual environment with Python 3.11")
    print("3. Install mediapipe in that environment")
    sys.exit(1)
...
if not cap.isOpened():
    print("Error: Cannot access the camera. Please check your camera connection.")
    exit()
